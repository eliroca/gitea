...
// ReparentForkOld sets the fork to be an unforked repository and the forked repo becomes its fork
func ReparentForkOld(ctx context.Context, forkedRepoID, srcForkID int64) error {
